...
const PARTNERS = [
  { name: "Terminal 3 SDK", role: "Identity Framework" },
  { name: "Intel TDX / SGX", role: "Secure Hardware" },
  { name: "T3N Ledger", role: "Audit Ledger" },
  { name: "W3C DIDs", role: "Identity Standard" },
  { name: "Zero-Knowledge", role: "Data Redaction" },
];
...
export function Stack() {
  return (
    <section
      id="resources"
      className="relative bg-obsidian py-32 md:py-44 px-6 md:px-16 border-t border-gold/10"
    >
