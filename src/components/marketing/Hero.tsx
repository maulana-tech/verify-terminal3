    ...
    <section className="relative min-h-screen overflow-hidden bg-obsidian">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 pt-40 pb-24">
        ...
        <div
          ...
          style={{
            animation: "fadeUp 1.6s cubic-bezier(0.16,1,0.3,1) 0.1s both",
          }}
        >
          <Image
            src="/fhox-logo.png"
        ...
        <div
          className="flex flex-col items-center"
          style={{ animation: "fadeIn 1.6s ease-out 0.2s both" }}
        >
        ...
        >
          TEE-Powered B2B Identity & Trust Broker
        </p>
        ...
        >
          Trust, verified in private<span className="text-gold">.</span>
        </h2>

        <p
          className="mt-7 text-stone text-base md:text-[17px] max-w-xl text-center leading-relaxed font-light"
          style={{
            animation: "fadeUp 1.4s cubic-bezier(0.16,1,0.3,1) 1.05s both",
          }}
        >
          <span className="text-bone tracking-[0.18em] text-[13px]">
            V-VERIFY
          </span>{" "}
          combines decentralized identifiers and TEE enclaves
          <br className="hidden md:block" />
          to authenticate enterprise vendor compliance without sharing raw PII.
        </p>
        ...
        <Link
          ...
          style={{
            animation: "fadeUp 1.4s cubic-bezier(0.16,1,0.3,1) 1.2s both",
          }}
        >
        ...
        >
          <span className="text-[9px] tracking-[0.48em] uppercase text-stone/60">
            Scroll
          </span>
